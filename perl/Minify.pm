...
#    close(OUTFILE);
    print HTML::Packer::minify($html, {  remove_comments => 1,  remove_newlines => 1,  no_compress_comment => 1,  html5 => 1  });
...
#    close(OUTFILE);
    print CSS::Minifier::XS::minify($css);
...
#    close(OUTFILE);
    print JavaScript::Minifier::XS::minify($js);
